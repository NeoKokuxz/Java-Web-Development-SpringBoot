...
@Repository
@Transactional
public class CandyDAOImplementation implements CandyDAO {

    @Autowired
    NamedParameterJdbcTemplate jdbcTemplate;

    //String constants for query
    ...
    @Override
    public List<CandyData> candyList() {
    ...
    public void addToDelivery(Long candyId, Long deliveryId) {
        jdbcTemplate.update(INSERT_DELIVERY,
                        new MapSqlParameterSource().addValue(CANDY_ID, candyId).addValue(DELIVERY_ID, deliveryId));
    }
